...
PARTITION TABLE MESSAGE_ENDPOINT_LINK ON COLUMN LINKID;
...
PARTITION TABLE MESSAGE_EXPRESSION_LINK ON COLUMN LINKID;
...
PARTITION TABLE EXPRESSION ON COLUMN EXPRESSIONID;
...
PARTITION TABLE CHECK ON COLUMN CHECKID;
...
PARTITION TABLE RULE_MULTICHECK_LINK ON COLUMN LINKID;
...
PARTITION TABLE MULTICHECK_CHECK_LINK ON COLUMN LINKID;
...
PARTITION TABLE MULTICHECK_MULTICHECK_LINK ON COLUMN LINKID;
