...
PARTITION PROCEDURE BLE_ChecksForExpression ON TABLE CHECK COLUMN PROPERTYID PARAMETER 1;
CREATE PROCEDURE FROM CLASS BLE_AllChecksForExpression;
PARTITION PROCEDURE BLE_AllChecksForExpression ON TABLE CHECK COLUMN PROPERTYID PARAMETER 1;
...
PARTITION PROCEDURE UpdateMultiChecks ON TABLE MULTICHECK COLUMN MULTICHECKID PARAMETER 1;
CREATE PROCEDURE FROM CLASS FindMultiChecksForMultiCheckID;
PARTITION PROCEDURE FindMultiChecksForMultiCheckID ON TABLE MULTICHECK COLUMN MULTICHECKID;
CREATE PROCEDURE FROM CLASS BLE_IsMultiCheckTrue;
PARTITION PROCEDURE BLE_IsMultiCheckTrue ON TABLE MULTICHECK COLUMN MULTICHECKID;
CREATE PROCEDURE FROM CLASS BLE_IsCycleMultiCheckTrue;
PARTITION PROCEDURE BLE_IsCycleMultiCheckTrue ON TABLE MULTICHECK COLUMN MULTICHECKID;
...
PARTITION PROCEDURE FindAllMultichecksForCheck ON TABLE MULTICHECK_CHECK_LINK COLUMN MULTICHECKID;
CREATE PROCEDURE FROM CLASS ImprovedFindAllMultichecksForCheck;
PARTITION PROCEDURE ImprovedFindAllMultichecksForCheck ON TABLE MULTICHECK_CHECK_LINK COLUMN MULTICHECKID;
CREATE PROCEDURE FROM CLASS FindChecksForMultiCheckID;
PARTITION PROCEDURE FindChecksForMultiCheckID ON TABLE MULTICHECK_CHECK_LINK COLUMN MULTICHECKID;
...
PARTITION TABLE MULTICHECK_MULTICHECK_LINK ON COLUMN MULTICHECKRID;
CREATE PROCEDURE FROM CLASS BLE_MultiCheckParentForMultiCheck;
PARTITION PROCEDURE BLE_MultiCheckParentForMultiCheck ON TABLE MULTICHECK_MULTICHECK_LINK COLUMN MULTICHECKRID;
...
PARTITION PROCEDURE FindParentMultiChecksForMultiCheckID ON TABLE MULTICHECK_MULTICHECK_LINK COLUMN MULTICHECKRID;
...
PARTITION PROCEDURE BLE_CheckPathForChecks ON TABLE CHECKPATH_CHECK_LINK COLUMN CHECKID;
